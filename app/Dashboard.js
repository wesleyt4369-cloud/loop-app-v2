...
const C = {
  bg: "#FAFAF7", ink: "#1C2B2D", inkSoft: "#5B6B68",
  primary: "#2F6F62", primaryLight: "#E7EFE9",
  warn: "#B5862B", warnLight: "#F5EBD6",
  danger: "#A8453D", dangerLight: "#F3E1DE",
  line: "#DEDAD0",
};
...
export default function Dashboard({ initialClients, bizName }) {
  ...
  return (
    <div style={{ background: C.bg, color: C.ink, minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ borderBottom: `1px solid ${C.line}`, padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ background: C.primary, width: 36, height: 36, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff" }}>
            <MessageCircle size={18} />
          </div>
          <div>
            <div style={{ fontSize: 20, fontWeight: 600 }}>Loop</div>
            <div style={{ color: C.inkSoft, fontSize: 13 }}>{bizName}</div>
          </div>
        </div>
        <button onClick={logout} style={{ border: `1px solid ${C.line}`, background: "transparent", borderRadius: 6, padding: "6px 12px", fontSize: 13, cursor: "pointer" }}>
          Log out
        </button>
      </div>
